...
import { ArrowRight, ShoppingCart, Package, CheckCircle, Shield, Heart, CreditCard, Truck, Share2 } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      ...
      <div className="container mx-auto px-4 py-8 lg:py-16">
        ...
        {/* How It Works Steps - Updated to 6 Steps */}
          ...
          <div className="hidden lg:grid grid-cols-3 gap-6">
            {steps.map((step, index) => (
              <div key={index} className="flex flex-col items-center text-center">
                ...
                <Card className="shadow-lg border-0 bg-white h-48 flex flex-col w-full">
        ...
        <div className="text-center mb-12 lg:mb-16">
          <Button 
            size="lg" 
            className="bg-gradient-to-r from-teal-500 to-blue-500 hover:from-teal-600 hover:to-blue-600 text-white px-8 py-4 text-lg font-semibold shadow-lg"
          >
            ...
            <div className="text-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-600">Items are delivered directly to DCPW Trust premises</p>
                </div>
                <div className="text-center">
                  <CreditCard className="w-8 h-8 text-blue-500 mx-auto mb-3" />
                  <h3 className="font-semibold text-gray-900 mb-2">Secure Payments</h3>
                  <p className="text-sm text-gray-600">All transactions are processed securely through Amazon (Prepaid only)</p>
                </div>
                <div className="text-center">
                  <Share2 className="w-8 h-8 text-red-500 mx-auto mb-3" />
                  <h3 className="font-semibold text-gray-900 mb-2">Social Impact</h3>
                  <p className="text-sm text-gray-600">Your contribution will be featured on our social media platforms</p>
                </div>
              </div>
            </div>
          </CardContent>
        ...
        <div className="text-center">
          <Card className="max-w-2xl mx-auto shadow-lg border-0 bg-gradient-to-r from-teal-500 to-blue-500">
            <CardContent className="p-6 lg:p-8 text-white">
              <h3 className="text-xl lg:text-2xl font-bold mb-4">Ready to Make a Difference?</h3>
